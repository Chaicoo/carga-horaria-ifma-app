...
import 'package:percent_indicator/linear_percent_indicator.dart'; // Importe o pacote necessário

class ExpandingCard extends StatefulWidget {
  final String title;
  final String row1Value;
  final String row2Value;
  final double progressPercent; // Adicione a propriedade para o progresso
